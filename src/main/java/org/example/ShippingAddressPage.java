...
public class ShippingAddressPage {
    public void addShippingAddress(ChromeDriver driver) {
        ...
        driver.findElement(By.name("firstName")).sendKeys("baganna");

        driver.findElement(By.name("lastName")).sendKeys("Kumbar");
    ...
    private void addContactDetails(ChromeDriver driver) {
        driver.findElement(By.name("email")).sendKeys("bagannak@testvagrant.com");
